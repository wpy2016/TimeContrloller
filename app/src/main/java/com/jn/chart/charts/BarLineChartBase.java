...
import com.jn.chart.renderer.XYDESCRender;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
    ...
    protected XYDESCRender mXYDESCRenderer;
    ...
    protected void init() {
        ...
        //在init方法中初始化
        mXYDesc = new XYDesc();
        mXYDESCRenderer = new XYDESCRender(mViewPortHandler, mXYDesc);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //在onDraw方法中绘制找到 mLegendRenderer.renderLegend(canvas);下面加一句
    ...
    public XYDESCRender getXYDESCRenderer() {
    ...
    public void setXYDesc(String xDesc, String yDesc, float textSize) {
        setXYDesc(xDesc, yDesc, textSize, Color.rgb(150,150,150));
    }
    ...
    public void setXYDesc(String xDesc, String yDesc, float textSize, int textColor) {
        ...
        if (mLegend.isEnabled() && (mLegend.getPosition() == Legend.LegendPosition.ABOVE_CHART_CENTER
            ...
            mXYDesc.setyPadding(1 * mLegend.getFormSize());
        }
        this.setExtraBottomOffset(1f + textSize);
        this.setExtraTopOffset(1f + textSize);
    }
}
